...
import { Mail, Phone, MapPin, Copy, Check, Send, AlertCircle } from 'lucide-react';
...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-12 max-w-5xl mx-auto px-4 sm:px-6 border-t border-neutral-900 space-y-10">
      <div className="mb-4">
        ...
        <p className="text-neutral-400 font-sans text-sm sm:text-base">
          Have a project in mind or looking for a software engineer? Send a message directly to my Gmail.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3 pt-2">
            <h3 className="font-serif text-2xl text-white font-normal">Follow me</h3>
            <div className="flex items-center gap-3">
              ...
              <a
                ...
                className="w-14 h-14 bg-[#121215] hover:bg-[#18181c] border border-neutral-800 hover:border-neutral-600 rounded-xl flex items-center justify-center text-white transition-all hover:scale-105 shadow-md cursor-pointer"
                title="GitHub"
              >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {status === 'submitting' ? (
              ...
              <span className="text-emerald-700 font-bold">Email Sent to Divyansh! ✓</span>
            ) : (
              <>
