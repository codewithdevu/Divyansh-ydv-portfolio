...
function StickyCardItem({ project, index, total, progress }: StickyCardProps) {
  ...
  return (
    <div
      className="sticky top-20 flex items-center justify-center w-full origin-top mb-8"
      style={{
    ...
    >
      <motion.div
        style={{ scale }}
        className="w-full bg-[#09090b] border border-neutral-800/90 rounded-2xl p-4 sm:p-5 shadow-2xl transition-colors hover:border-neutral-700 space-y-4"
      >
        {/* macOS Browser Window Frame Container */}
        <div className="relative w-full rounded-xl overflow-hidden border border-neutral-800/90 bg-[#09090b] shadow-lg flex flex-col">
          {/* Top Browser Header Bar */}
          <div className="flex items-center justify-between px-3.5 sm:px-4 py-2.5 bg-[#121215] border-b border-neutral-800/80">
            ...
            {project.liveUrl && (
              <div className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1 rounded-full bg-neutral-900 border border-neutral-800 text-[10px] sm:text-[11px] font-mono text-cyan-400 font-medium truncate max-w-[180px] sm:max-w-[240px]">
...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" className="py-12 max-w-5xl mx-auto px-4 sm:px-6 border-t border-neutral-900">
      ...
      <div className="hidden md:grid md:grid-cols-2 gap-8 sm:gap-10 items-start">
